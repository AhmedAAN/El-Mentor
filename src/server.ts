...
const io = new Server(httpServer, {
  cors: {
    origin: ['http://127.0.0.1:5500', "http://localhost:5500", "https://ahmedaan.github.io", "http://localhost:5000", "https://el-mentor.my.to"], // Allow requests from this origin
...
app.use(cors({
  origin: ['http://127.0.0.1:5500', "http://localhost:5500", "https://ahmedaan.github.io", "https://el-mentor.my.to"], // Allow requests from this origin
  methods: ["GET", "POST", "DELETE", "PATCH", "PUT"], // Allow these HTTP methods
